...
SET sv_link_libs= user32.lib Comdlg32.lib Ole32.lib Shell32.lib %VULKAN_SDK%\Lib\vulkan-1.lib sprv.lib PhysXCommon_64.lib PhysXFoundation_64.lib PhysX_64.lib PhysXExtensions_static_64.lib
