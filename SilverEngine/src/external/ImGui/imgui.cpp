...
/*
 ...
 - Call and read ImGui::() for demo code demonstrating most features.
 ...
 - 2017/12/24 (1.53) - renamed the emblematic ShowTestWindow() function to (). Kept redirection function (will obsolete).
