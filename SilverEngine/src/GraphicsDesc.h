...
enum SV_GFX_BLEND
{
	SV_GFX_BLEND_ZERO = 1,
	SV_GFX_BLEND_ONE = 2,
	SV_GFX_BLEND_SRC_COLOR = 3,
	SV_GFX_BLEND_INV_SRC_COLOR = 4,
	SV_GFX_BLEND_SRC_ALPHA = 5,
	SV_GFX_BLEND_INV_SRC_ALPHA = 6,
	SV_GFX_BLEND_DEST_ALPHA = 7,
	SV_GFX_BLEND_INV_DEST_ALPHA = 8,
	SV_GFX_BLEND_DEST_COLOR = 9,
	SV_GFX_BLEND_INV_DEST_COLOR = 10,
	SV_GFX_BLEND_SRC_ALPHA_SAT = 11,
	SV_GFX_BLEND_BLEND_FACTOR = 14,
	SV_GFX_BLEND_INV_BLEND_FACTOR = 15,
	SV_GFX_BLEND_SRC1_COLOR = 16,
	SV_GFX_BLEND_INV_SRC1_COLOR = 17,
	SV_GFX_BLEND_SRC1_ALPHA = 18,
	SV_GFX_BLEND_INV_SRC1_ALPHA = 19
};

enum SV_GFX_BLEND_OP
{
	SV_GFX_BLEND_OP_ADD = 1,
	SV_GFX_BLEND_OP_SUBTRACT = 2,
	SV_GFX_BLEND_OP_REV_SUBTRACT = 3,
	SV_GFX_BLEND_OP_MIN = 4,
	SV_GFX_BLEND_OP_MAX = 5
};

enum SV_GFX_COLOR_WRITE_ENABLE
{
	SV_GFX_COLOR_WRITE_ENABLE_RED = 1,
	SV_GFX_COLOR_WRITE_ENABLE_GREEN = 2,
	SV_GFX_COLOR_WRITE_ENABLE_BLUE = 4,
	SV_GFX_COLOR_WRITE_ENABLE_ALPHA = 8,
...
#define SV_GFX_CPU_ACCESS_NONE	0
#define SV_GFX_CPU_ACCESS_WRITE SV_BIT(0)
#define SV_GFX_CPU_ACCESS_READ	SV_BIT(1)