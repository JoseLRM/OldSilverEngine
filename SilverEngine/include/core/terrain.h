...
namespace sv {
	...
	SV_API void terrain_apply_heightmap_u8(TerrainComponent& terrain, const u8* heights, u32 size_x, u32 size_y, u32 stride);
	SV_API bool terrain_apply_heightmap_image(TerrainComponent& terrain, const char* filepath);

	SV_API void terrain_set_flat(TerrainComponent& terrain, f32 height, u32 size_x, u32 size_z);
