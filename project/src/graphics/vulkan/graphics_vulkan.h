...
namespace sv {
	...
	void graphics_vulkan_present(SwapChain_internal* swapChain, GPUImage* image, const GPUImageRegion& region, GPUImageLayout layout, CommandList cmd); // Blit image into swapchain image
